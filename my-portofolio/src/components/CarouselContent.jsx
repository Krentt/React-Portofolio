...
const CarouselContent = ({
  ...
  return (
    <div
      id={`slide${id}`}
      className="carousel-item relative w-full card image-full"
    >
      <figure>
      ...
      <div className="card-body">
        <div className="flex flex-col items-center my-auto">
          ...
          <a
            href={github}
            className="mt-4 flex items-center p-2 hover:bg-black/[.4] rounded-lg"
          >
            <svg
        ...
        <div className="hidden absolute lg:flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
